<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="BudgetPlan.aspx.cs" Inherits="BudgetPlan.BudgetPlan" %>
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="RadGridSearch">
                <UpdatedControls>                        
                    ...
                    <telerik:AjaxUpdatedControl ControlID="RadButtonSearchTemplate"/>
                    <telerik:AjaxUpdatedControl ControlID="RadButtonDelete"/>
            ...
            <telerik:LayoutRow>
                <Columns>
                    ...
                    <div>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceSearchPlanHed" runat="server" ConnectionString="<%$ ConnectionStrings:BudgetPlanConnectionString %>" SelectCommand="SELECT * FROM [BudgetPlanHed] WHERE [Company]=@Company and InactiveRevision=0 ORDER BY [Company], [EntryNum], [Revision]">
                                <SelectParameters>
                ...
                <Columns>
                    <telerik:LayoutColumn Span="10" SpanMd="12" SpanSm="12" SpanXs="12">
                        <div>
                            ...
                            <telerik:RadButton ID="RadButtonVoid" runat="server" Text="Void" Skin="Web20" OnClick="RadButtonVoid_Click" OnClientClicking="function (sender, args){args.set_cancel(!window.confirm('Are you sure void?'));}">
                            </telerik:RadButton>
