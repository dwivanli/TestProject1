<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="BudgetEntryR2.aspx.cs" Inherits="BudgetPlan.BudgetEntryR2" %>
            ...
            switch (colName) {
                case 'GLAccount':
                    ...
                    */
                    ...
                    $.ajax({
                        url: "BudgetEntryR2.aspx/AjaxMethod_GetPreloadAccountDesc",//发送到本页面后台AjaxMethod方法
                        type: "POST",
                        dataType: "json",
        ...
        <Rows>
            <telerik:LayoutRow>
                <Columns>
                    ...
                    <div>
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceSearchPlanHed" runat="server" ConnectionString="<%$ ConnectionStrings:BudgetPlanConnectionString %>" SelectCommand="SELECT * FROM [BudgetPlanHed] WHERE [Company]=@Company and [AssignTo]=@AssignTo and ([Status]='Pending Budget Entry' or [Status]='Pending Approval' or [Status]='Approved' or [Status]='Rejected') and [InactiveRevision]=0 ORDER BY [Company], [EntryNum], [Revision]">
                                <SelectParameters>
                    ...
                    <telerik:LayoutColumn Span="10" SpanMd="12" SpanSm="12" SpanXs="12">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td>
                                    <telerik:RadLabel ID="RadLabelAssignTo" runat="server" AssociatedControlID="RadComboBoxAssignTo" Visible="false">
                                        Assign To
                                    </telerik:RadLabel>
                                    <telerik:RadComboBox runat="server" ID="RadComboBoxAssignTo"  EnableLoadOnDemand="true" DataSourceID="SqlDataSourceAssignTo" DataTextField="Name" DataValueField="UserID" AutoPostBack="true" Visible="false"></telerik:RadComboBox>
            ...
            <telerik:LayoutRow>
                <Columns>
                    <telerik:LayoutColumn Span="10" SpanMd="12" SpanSm="12" SpanXs="12">
                        <div>
                            <telerik:RadButton ID="RadButtonNew" runat="server" Text="New Entry#" Skin="Web20" OnClick="RadButtonNew_Click" Visible="false">
                            </telerik:RadButton>
                            <telerik:RadButton ID="RadButtonSave" runat="server" Text="Save Entry#" Skin="Web20" OnClick="RadButtonSave_Click">
                            </telerik:RadButton>
                            <telerik:RadButton ID="RadButtonSearchTemplate" runat="server" Text="Copy by Template" Skin="Web20" OnClick="RadButtonSearchTemplate_Click" Visible="false">
                            </telerik:RadButton>
                            <telerik:RadButton ID="RadButtonCopy" runat="server" Text="Copy" Skin="Web20" OnClick="RadButtonCopy_Click" Visible="false">
                            </telerik:RadButton>
                            ...
                            <telerik:RadButton ID="RadButtonConfirmAssign" runat="server" Text="Confirm & Assign" Skin="Telerik" OnClick="RadButtonConfirmAssign_Click" Visible="false">
                            </telerik:RadButton>
                            ...
                            <telerik:RadButton ID="RadButtonVoid" runat="server" Text="Void" Skin="Web20" OnClick="RadButtonVoid_Click" Visible="false">
                            </telerik:RadButton>
                            <telerik:RadButton ID="RadButtonDelete" runat="server" Text="Delete" Skin="Web20" OnClick="RadButtonDelete_Click" Visible="false">
                            </telerik:RadButton>
                        </div>                        
                    </telerik:LayoutColumn>
                </Columns>
