...
{
    public class ClassEpicor
    {
		protected static string ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["EpicorConnectionString"].ConnectionString;
		...
		public int RunSQL(string SQLStr, ref string Msg)
		{
			Msg = "";
